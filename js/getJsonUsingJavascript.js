...
var url = "https://api.myjson.com/bins/3txq7";
...
function myFunction(response) {
    ...
    var powerConsumptionObject = arr.powerConsumption;
    var days = Object.keys(powerConsumptionObject);
    for(key in powerConsumptionObject) {
        powerConsumptionData.push(powerConsumptionObject[key]);
    }
    console.log("powerConsumptionData: " + powerConsumptionData);
    console.log("Type of powerConsumptionData: " + typeof(powerConsumptionData));
    console.log("Type of days: " + typeof(days));
    var i;

    var outHTML = '<h3>Power consumption for '+ arr.name + ' ' + arr.surname + ' </h3>';
...
<thead>\
      ...
      var j = 0;
    for (var key in arr.powerConsumption){
        outHTML += '<tr><td>' + key + '</td><td>' + arr.powerConsumption[key] + '</td></tr>'
        j++;
    }
    outHTML += '</tbody></table>';
    //document.getElementById("powerChart").innerHTML = outHTML;
    console.log(outHTML);
...
function Meteogram(xml, weatherContainer) {
...
Meteogram.prototype.getChartOptions = function () {
    ...
    return {
        chart: {
            renderTo: this.weatherContainer,
            marginBottom: 70,
            marginRight: 40,
            marginTop: 50,
            plotBorderWidth: 1,
...
$(function () { // On DOM ready...
    ...
    if (!location.hash) {
        ...
        //place = 'Norway/Sogn_og_Fjordane/Førde/Førde';
        //place = 'Norway/Sogn_og_Fjordane/Fjaler/Dale';
        place = 'Norway/Sogn_og_Fjordane/Askvoll/Kvammen';
    ...
    $.getJSON(
        ...
        function (xml) {
            var meteogram = new Meteogram(xml, 'weatherContainer');
        }
    );
